...
$_['text_checkout_shipping_method']  = 'Bước 3: Phương Thức Giao Hàng';
$_['text_checkout_payment_method']   = 'Bước 4: Phương Thức Thanh Toán';
$_['text_checkout_confirm']          = 'Bước 5: Xác Nhận Đơn Hàng';
...
$_['text_agree']                     = 'Tôi đã Đọc & Đồng ý với <a href="%s" class="agree"><b>%s</b></a>';
$_['text_address_new']               = 'Tôi muốn dùng địa chỉ mới';
$_['text_address_existing']          = 'Tôi muốn dùng địa chỉ đã Đăng ký';
$_['text_shipping_method']           = 'Hãy chọn phương thức Vận chuyển:';
$_['text_payment_method']            = 'Hãy chọn phương thức Thanh toán:';
...
$_['entry_newsletter']               = 'Đăng ký nhận bản tin %s .';
...
$_['error_no_shipping']              = 'Lỗi! Sản phẩm này chưa thiết lập các Phương thức Vận chuyển! Vui lòng <a href="%s">Liên hệ</a> và thông báo chúng tôi được biết!';
