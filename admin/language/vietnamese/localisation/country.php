...
$_['text_list']               = 'Danh mục Quốc gia';
$_['text_add']                = 'Thêm Quốc gia';
$_['text_edit']               = 'Cập nhật Quốc gia';
...
// Help
$_['help_address_format']     = 'Họ = {firstname}<br />Tên đệm & Tên = {lastname}<br />Công ty = {company}<br />Địa chỉ dòng 1 = {address_1}<br />Địa chỉ dòng 2 = {address_2}<br />Quận / Huyện = {city}<br />Mã Bưu điện = {postcode}<br />Tỉnh / Thành phố = {zone}<br />Mã Tỉnh / Thành phố = {zone_code}<br />Quốc gia = {country}';
