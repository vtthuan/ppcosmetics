...
$_['entry_catalog_limit'] 	    = 'Mặc định Tìm Mỗi trang(Danh mục):<br /><span class="help">Xác định như thế nào các Shop nhiều sẽ được hiển thị trên mỗi trang (sản phẩm, chủng loại, vv)</span>';
...
$_['error_store']               = 'Cảnh báo: Shop này không thể bị xóa vì nó đang dùng cho %s đơn hàng!';
?>